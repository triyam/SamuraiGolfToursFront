...
const Footer = () => (
	<>
    	...
    	<Link className="left" to="/lorem" state={{ title: "About US" }}>About US</Link>
      	<span>|</span>
      	<Link className="left" to="/lorem2" state={{ title: "ゴルフ場・宿泊・観光地の登録について" }}>ゴルフ場・宿泊・観光地の登録について</Link>
      	<span>|</span>
      <Link className="left" to="/lorem" state={{ title: "利用規約" }}>利用規約</Link>
      <span>|</span>
      <Link className="left" to="/lorem2" state={{ title: "プライバシー" }}>プライバシー</Link>
      <span>|</span>
      <Link className="left" to="/lorem" state={{ title: "行政・観光協会の皆様へ" }}>行政・観光協会の皆様へ</Link>
      <span>|</span>
      <Link className="left" to="/lorem2" state={{ title: "お問合せ" }}>お問合せ</Link>
      <span>|</span>
      <Link className="left" to="/lorem" state={{ title: "企業情報" }}>企業情報</Link>
      <span>|</span>
      <Link className="left" to="/lorem2" state={{ title: "キャンセルポリシー" }}>キャンセルポリシー</Link> 
    </div>
